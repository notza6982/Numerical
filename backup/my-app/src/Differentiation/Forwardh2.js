...
class Forwardh2 extends Component{
    ...
    return(
      ...
      <Leftmenu/>
       ...
       <h1 style={{textAlign: 'center' }}><Text underline type="warning" >Forwardh^2</Text></h1>
    ...
    <InputNumber placeholder="8" type='Number'  name="h" defaultValue={this.state.h}  /> 
      ...
      <h1 style={{textAlign: 'center' }}><Button type="primary" size='large' onClick= { ()=>this.forward(Number(this.state.order),Number(this.state.x),Number(this.state.h))}>
	  <Link to="/Differentiation/Forwardh2">Submit</Link></Button></h1>
      </form>
	  <br /> 
