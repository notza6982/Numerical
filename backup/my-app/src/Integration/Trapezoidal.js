...
class Trapezoidal extends Component{
	constructor() {
	 ...
	 trap(a,b){
      var h = (b-a)/2;
      var I = (h / 2) * (this.func(a) + this.func(b));
      var exact = this.exactIntegrate(a, b);
      var error = Math.abs((exact-I) / exact) * 100;
      console.log(this.func(a));console.log(this.func(b));console.log(this.func(h))
    ...
    return(
      ...
      <Leftmenu/>
       ...
       <h1 style={{textAlign: 'center' }}><Text underline type="warning" >Trapezoidal</Text></h1>
    ...
    <InputNumber placeholder="8" type='Number'  name="b" defaultValue={this.state.b}  /> 
      ...
      <h1 style={{textAlign: 'center' }}><Button type="primary" size='large' onClick= { ()=>this.trap(Number(this.state.a),Number(this.state.b))}>
	  <Link to="/Integration/Trapezoidal">Submit</Link></Button></h1>
      </form>
	  <br /> 
